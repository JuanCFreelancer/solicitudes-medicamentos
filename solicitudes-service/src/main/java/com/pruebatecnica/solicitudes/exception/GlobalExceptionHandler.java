...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(MedicamentoNoDisponibleException.class)
    ProblemDetail handleMedicamentoNoDisponible(MedicamentoNoDisponibleException ex) {
        ProblemDetail problem = ProblemDetail.forStatusAndDetail(HttpStatus.UNPROCESSABLE_ENTITY, ex.getMessage());
        problem.setTitle("Medicamento no disponible");
        return problem;
    }
